    ...
    if (roleForm) {
        ...
        roleCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                // Dapatkan nilai 'data-role' dan simpan di hidden input
...
// --- LOGIKA UNTUK ADMIN DASHBOARD SIDEBAR ---
...
if (adminWrapper) {
    ...
    if (currentPath.includes('/admin/dashboard')) {
        ...
        document.getElementById('nav-barang').classList.add('active');
    } else if (currentPath.includes('/admin/kelas')) {
        document.getElementById('nav-kelas').classList.add('active');
    } else if (currentPath.includes('/admin/laporan')) {
